...
%Class=[1;2;3]; %Generating class Label
%Label=repmat(Class,21,1); %Class array for all the clases

Accuracy=AccMeasure(class_labels,idx); %Measuring the accuracy of clusters
