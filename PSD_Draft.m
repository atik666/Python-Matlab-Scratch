...
for i=1:floor(L)
    ...
    [PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
for i=1:length(PSD)
...
base_PSD_V=horzcat(PSD_rms_data,PSD_var_data,PSD_means_data,PSD_std_data,PSD_kurtosis_data,PSD_skewness_data,Label1);
base_PSD_T=array2table(base_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_IR007)
    ...
    k=k+floor(data_cycle);
    [IR007_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
IR007_PSD_V=horzcat(IR007_PSD_rms_data,IR007_PSD_var_data,IR007_PSD_means_data,IR007_PSD_std_data,IR007_PSD_kurtosis_data,IR007_PSD_skewness_data,Label2);
IR007_PSD_T=array2table(IR007_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_IR014)
    ...
    k=k+floor(data_cycle);
    [IR014_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
IR014_PSD_V=horzcat(IR014_PSD_rms_data,IR014_PSD_var_data,IR014_PSD_means_data,IR014_PSD_std_data,IR014_PSD_kurtosis_data,IR014_PSD_skewness_data,Label3);
IR014_PSD_T=array2table(IR014_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_IR021)
    ...
    k=k+floor(data_cycle);
    [IR021_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
IR021_PSD_V=horzcat(IR021_PSD_rms_data,IR021_PSD_var_data,IR021_PSD_means_data,IR021_PSD_std_data,IR021_PSD_kurtosis_data,IR021_PSD_skewness_data,Label4);
IR021_PSD_T=array2table(IR021_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_OR007_6_0)
    ...
    k=k+floor(data_cycle);
    [OR007_6_0_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
OR007_6_0_PSD_V=horzcat(OR007_6_0_PSD_rms_data,OR007_6_0_PSD_var_data,OR007_6_0_PSD_means_data,OR007_6_0_PSD_std_data,OR007_6_0_PSD_kurtosis_data,OR007_6_0_PSD_skewness_data,Label5);
OR007_6_0_PSD_T=array2table(OR007_6_0_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_OR014_6_0)
    ...
    k=k+floor(data_cycle);
    [OR014_6_0_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
OR014_6_0_PSD_V=horzcat(OR014_6_0_PSD_rms_data,OR014_6_0_PSD_var_data,OR014_6_0_PSD_means_data,OR014_6_0_PSD_std_data,OR014_6_0_PSD_kurtosis_data,OR014_6_0_PSD_skewness_data,Label6);
OR014_6_0_PSD_T=array2table(OR014_6_0_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_OR021_6_0)
    ...
    k=k+floor(data_cycle);
    [OR021_6_0_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
OR021_6_0_PSD_V=horzcat(OR021_6_0_PSD_rms_data,OR021_6_0_PSD_var_data,OR021_6_0_PSD_means_data,OR021_6_0_PSD_std_data,OR021_6_0_PSD_kurtosis_data,OR021_6_0_PSD_skewness_data,Label7);
OR021_6_0_PSD_T=array2table(OR021_6_0_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_B007_0)
    ...
    k=k+floor(data_cycle);
    [B007_0_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
B007_0_PSD_V=horzcat(B007_0_PSD_rms_data,B007_0_PSD_var_data,B007_0_PSD_means_data,B007_0_PSD_std_data,B007_0_PSD_kurtosis_data,B007_0_PSD_skewness_data,Label8);
B007_0_PSD_T=array2table(B007_0_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_B014_0)
    ...
    k=k+floor(data_cycle);
    [B014_0_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
B014_0_PSD_V=horzcat(B014_0_PSD_rms_data,B014_0_PSD_var_data,B014_0_PSD_means_data,B014_0_PSD_std_data,B014_0_PSD_kurtosis_data,B014_0_PSD_skewness_data,Label9);
B014_0_PSD_T=array2table(B014_0_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
for i=1:floor(L_B021_0)
    ...
    k=k+floor(data_cycle);
    [B021_0_PSD{i,1}]=Mide_FFT_PSD(E,Fs);   %PSD of the signal
end
...
B021_0_PSD_V=horzcat(B021_0_PSD_rms_data,B021_0_PSD_var_data,B021_0_PSD_means_data,B021_0_PSD_std_data,B021_0_PSD_kurtosis_data,B021_0_PSD_skewness_data,Label10);
B021_0_PSD_T=array2table(B021_0_PSD_V, 'VariableNames', {'RMS','Variance','Mean','STD','Kurtosis','Skewness','Label'});
...
%% -------------- Building Classifier ----------------------------
classification_model_nb=fitcnb(data,'class_labels~PC1+PC2');

classification_model_svm=fitcecoc(data,'class_labels~PC1+PC2');

classification_model_knn=fitcknn(data,'class_labels~PC1+PC2');
%% -------------- Test and Train sets ----------------------------
 
cv_nb=cvpartition(classification_model_nb.NumObservations,'HoldOut', 0.3);
cross_validated_model_nb=crossval(classification_model_nb,'cvpartition',cv_nb);

cv_svm=cvpartition(classification_model_svm.NumObservations,'HoldOut', 0.3);
cross_validated_model_svm=crossval(classification_model_svm,'cvpartition',cv_svm);

cv_knn=cvpartition(classification_model_knn.NumObservations,'HoldOut', 0.3);
cross_validated_model_knn=crossval(classification_model_knn,'cvpartition',cv_knn);
%% -------------- Making Predictions for Test sets ---------------
 
predictions_nb=predict(cross_validated_model_nb.Trained{1},data(test(cv_nb),1:end-1));

predictions_svm=predict(cross_validated_model_svm.Trained{1},data(test(cv_svm),1:end-1));

predictions_knn=predict(cross_validated_model_knn.Trained{1},data(test(cv_knn),1:end-1));
 
%% -------------- Analyzing the predictions ---------------------
 
results_nb=confusionmat(cross_validated_model_nb.Y(test(cv_nb)),predictions_nb)

results_svm=confusionmat(cross_validated_model_svm.Y(test(cv_svm)),predictions_svm)

results_knn=confusionmat(cross_validated_model_knn.Y(test(cv_knn)),predictions_knn)
 
%% Calculating the accuracy of the confusion matrix
sum=0;
for i=1:length(results_nb)
sum=sum+results_nb(i,i);
end
accuracy_nb=sum/length(predictions_nb)*100;

sum=0;
for i=1:length(results_svm)
sum=sum+results_svm(i,i);
end
accuracy_svm=sum/length(predictions_svm)*100;

sum=0;
for i=1:length(results_knn)
sum=sum+results_knn(i,i);
end
accuracy_knn=sum/length(predictions_knn)*100;
