function [TrainingTime, TestingTime, TrainingAccuracy, TestingAccuracy, T,P,TY,label_index_expected,label_index_actual,Y,x] = elm(TrainingData_File, TestingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
