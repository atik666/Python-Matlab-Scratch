...
data = pd.read_excel (r'D:\AAA\Udemy - Deep Learning A-Ztrade;_ Hands-On Artificial Neural Networks [Desire Course]\29. Data Preprocessing Template\LMD_4.xlsx') 
X = data.iloc[0:360,:-1].values
y_data = data.iloc[0:360,-1].values
