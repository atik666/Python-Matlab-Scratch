# -*- coding: utf-8 -*-
"""
Created on Tue May 26 11:43:17 2020
...
# XY0 = np.array([1,1,1,1,0,0,1,0,1,0,1])

XY0 = np.random.randint(2, size=74)

p_c = 1 # prob. of crossover
p_m = 0.3 # prob. of mutation
pop = 100
gen = 50
kfold = 3 
