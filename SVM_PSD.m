...
for i=1:floor(L)
    ...
    [~,PSD{i,1}]=AV_PSD(E);   %PSD of the signal
...
for i=1:floor(L_IR007)
    ...
    k=k+floor(data_cycle);
    [~,IR007_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_IR014)
    ...
    k=k+floor(data_cycle);
    [~,IR014_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_IR021)
    ...
    k=k+floor(data_cycle);
    [~,IR021_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_OR007_6_0)
    ...
    k=k+floor(data_cycle);
    [~,OR007_6_0_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_OR014_6_0)
    ...
    k=k+floor(data_cycle);
    [~,OR014_6_0_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_OR021_6_0)
    ...
    k=k+floor(data_cycle);
    [~,OR021_6_0_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_B007_0)
    ...
    k=k+floor(data_cycle);
    [~,B007_0_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_B014_0)
    ...
    k=k+floor(data_cycle);
    [~,B014_0_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
...
for i=1:floor(L_B021_0)
    ...
    k=k+floor(data_cycle);
    [~,B021_0_PSD{i,1}]=AV_PSD(E);   %PSD of the signal
end
