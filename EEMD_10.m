...
for i=1:L
    ...
    IMF_DE{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X097_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE{i,1} = eemd(F, num_IMF, NR, Nstd);
end     
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_IR_007{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X105_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_IR_007{i,1} = eemd(F, num_IMF, NR, Nstd);
end     
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_IR_014{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X169_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_IR_014{i,1} = eemd(F, num_IMF, NR, Nstd);
end     
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_IR_021{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X209_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_IR_021{i,1} = eemd(F, num_IMF, NR, Nstd);
end     
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_OR_007{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X130_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_OR_007{i,1} = eemd(F, num_IMF, NR, Nstd);
end  
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_OR_014{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X197_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_OR_014{i,1} = eemd(F, num_IMF, NR, Nstd);
end
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_OR_021{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X234_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_OR_021{i,1} = eemd(F, num_IMF, NR, Nstd);
end
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_BF_007{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X118_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_BF_007{i,1} = eemd(F, num_IMF, NR, Nstd);
end
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_BF_014{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X185_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_BF_014{i,1} = eemd(F, num_IMF, NR, Nstd);
end
...
for i=1:L
    ...
    k=k+floor(data_cycle);
    IMF_DE_BF_021{i,1} = eemd(E, num_IMF, NR, Nstd);
    F = X222_FE_time(k:k+floor(data_cycle)-1);
    IMF_FE_BF_021{i,1} = eemd(F, num_IMF, NR, Nstd);
end
...
IMF_DE_eemd_V=horzcat(IMF_DE_rms,IMF_DE_var,IMF_DE_means,IMF_DE_std,IMF_DE_kurtosis,...
    IMF_DE_skewness,IMF_DE_peaks, IMF_DE_crestFactor, IMF_DE_entropy);
IMF_FE_eemd_V=horzcat(IMF_FE_rms,IMF_FE_var,IMF_FE_means,IMF_FE_std,IMF_FE_kurtosis,...
    IMF_FE_skewness,IMF_FE_peaks, IMF_FE_crestFactor, IMF_FE_entropy,Label1);

IMF_DE_eemd_V = cell2mat(IMF_DE_eemd_V);
IMF_FE_eemd_V = cell2mat(IMF_FE_eemd_V);

IMF_1 = [IMF_DE_eemd_V, IMF_FE_eemd_V];

Label2=2*ones(L,1);
Label2 = num2cell(Label2);

IMF_DE_IR_007_eemd_V=horzcat(IMF_DE_IR_007_rms,IMF_DE_IR_007_var,IMF_DE_IR_007_means,IMF_DE_IR_007_std,IMF_DE_IR_007_kurtosis,...
    IMF_DE_IR_007_skewness,IMF_DE_IR_007_peaks, IMF_DE_IR_007_crestFactor, IMF_DE_IR_007_entropy);
IMF_FE_IR_007_eemd_V=horzcat(IMF_FE_IR_007_rms,IMF_FE_IR_007_var,IMF_FE_IR_007_means,IMF_FE_IR_007_std,IMF_FE_IR_007_kurtosis,...
    IMF_FE_IR_007_skewness,IMF_FE_IR_007_peaks, IMF_FE_IR_007_crestFactor, IMF_FE_IR_007_entropy,Label2);

IMF_DE_IR_007_eemd_V = cell2mat(IMF_DE_IR_007_eemd_V);
IMF_FE_IR_007_eemd_V = cell2mat(IMF_FE_IR_007_eemd_V);

IMF_2 = [IMF_DE_IR_007_eemd_V, IMF_FE_IR_007_eemd_V];

Label3=3*ones(L,1);
Label3 = num2cell(Label3);

IMF_DE_IR_014_eemd_V=horzcat(IMF_DE_IR_014_rms,IMF_DE_IR_014_var,IMF_DE_IR_014_means,IMF_DE_IR_014_std,IMF_DE_IR_014_kurtosis,...
    IMF_DE_IR_014_skewness,IMF_DE_IR_014_peaks, IMF_DE_IR_014_crestFactor, IMF_DE_IR_014_entropy);
IMF_FE_IR_014_eemd_V=horzcat(IMF_FE_IR_014_rms,IMF_FE_IR_014_var,IMF_FE_IR_014_means,IMF_FE_IR_014_std,IMF_FE_IR_014_kurtosis,...
    IMF_FE_IR_014_skewness,IMF_FE_IR_014_peaks, IMF_FE_IR_014_crestFactor, IMF_FE_IR_014_entropy,Label3);

IMF_DE_IR_014_eemd_V = cell2mat(IMF_DE_IR_014_eemd_V);
IMF_FE_IR_014_eemd_V = cell2mat(IMF_FE_IR_014_eemd_V);

IMF_3 = [IMF_DE_IR_014_eemd_V, IMF_FE_IR_014_eemd_V];

Label4=4*ones(L,1);
Label4 = num2cell(Label4);

IMF_DE_IR_021_eemd_V=horzcat(IMF_DE_IR_021_rms,IMF_DE_IR_021_var,IMF_DE_IR_021_means,IMF_DE_IR_021_std,IMF_DE_IR_021_kurtosis,...
    IMF_DE_IR_021_skewness,IMF_DE_IR_021_peaks, IMF_DE_IR_021_crestFactor, IMF_DE_IR_021_entropy);
IMF_FE_IR_021_eemd_V=horzcat(IMF_FE_IR_021_rms,IMF_FE_IR_021_var,IMF_FE_IR_021_means,IMF_FE_IR_021_std,IMF_FE_IR_021_kurtosis,...
    IMF_FE_IR_021_skewness,IMF_FE_IR_021_peaks, IMF_FE_IR_021_crestFactor, IMF_FE_IR_021_entropy,Label4);

IMF_DE_IR_021_eemd_V = cell2mat(IMF_DE_IR_021_eemd_V);
IMF_FE_IR_021_eemd_V = cell2mat(IMF_FE_IR_021_eemd_V);

IMF_4 = [IMF_DE_IR_021_eemd_V, IMF_FE_IR_021_eemd_V];

Label5=5*ones(L,1);
Label5 = num2cell(Label5);
IMF_DE_OR_007_eemd_V=horzcat(IMF_DE_OR_007_rms,IMF_DE_OR_007_var,IMF_DE_OR_007_means,IMF_DE_OR_007_std,IMF_DE_OR_007_kurtosis,IMF_DE_OR_007_skewness,IMF_DE_OR_007_peaks, IMF_DE_OR_007_crestFactor, IMF_DE_OR_007_entropy);
IMF_FE_OR_007_eemd_V=horzcat(IMF_FE_OR_007_rms,IMF_FE_OR_007_var,IMF_FE_OR_007_means,IMF_FE_OR_007_std,IMF_FE_OR_007_kurtosis,IMF_FE_OR_007_skewness,IMF_FE_OR_007_peaks, IMF_FE_OR_007_crestFactor, IMF_FE_OR_007_entropy,Label5);

IMF_DE_OR_007_eemd_V = cell2mat(IMF_DE_OR_007_eemd_V);
IMF_FE_OR_007_eemd_V = cell2mat(IMF_FE_OR_007_eemd_V);

IMF_5 = [IMF_DE_OR_007_eemd_V, IMF_FE_OR_007_eemd_V];

Label6=6*ones(L,1);
Label6 = num2cell(Label6);

IMF_DE_OR_014_eemd_V=horzcat(IMF_DE_OR_014_rms,IMF_DE_OR_014_var,IMF_DE_OR_014_means,IMF_DE_OR_014_std,IMF_DE_OR_014_kurtosis,...
    IMF_DE_OR_014_skewness,IMF_DE_OR_014_peaks, IMF_DE_OR_014_crestFactor, IMF_DE_OR_014_entropy);
IMF_FE_OR_014_eemd_V=horzcat(IMF_FE_OR_014_rms,IMF_FE_OR_014_var,IMF_FE_OR_014_means,IMF_FE_OR_014_std,IMF_FE_OR_014_kurtosis,...
    IMF_FE_OR_014_skewness,IMF_FE_OR_014_peaks, IMF_FE_OR_014_crestFactor, IMF_FE_OR_014_entropy,Label6);

IMF_DE_OR_014_eemd_V = cell2mat(IMF_DE_OR_014_eemd_V);
IMF_FE_OR_014_eemd_V = cell2mat(IMF_FE_OR_014_eemd_V);

IMF_6 = [IMF_DE_OR_014_eemd_V, IMF_FE_OR_014_eemd_V];

Label7=7*ones(L,1);
Label7 = num2cell(Label7);
IMF_DE_OR_021_eemd_V=horzcat(IMF_DE_OR_021_rms,IMF_DE_OR_021_var,IMF_DE_OR_021_means,IMF_DE_OR_021_std,IMF_DE_OR_021_kurtosis,IMF_DE_OR_021_skewness,IMF_DE_OR_021_peaks, IMF_DE_OR_021_crestFactor, IMF_DE_OR_021_entropy);
IMF_FE_OR_021_eemd_V=horzcat(IMF_FE_OR_021_rms,IMF_FE_OR_021_var,IMF_FE_OR_021_means,IMF_FE_OR_021_std,IMF_FE_OR_021_kurtosis,IMF_FE_OR_021_skewness,IMF_FE_OR_021_peaks, IMF_FE_OR_021_crestFactor, IMF_FE_OR_021_entropy,Label7);

IMF_DE_OR_021_eemd_V = cell2mat(IMF_DE_OR_021_eemd_V);
IMF_FE_OR_021_eemd_V = cell2mat(IMF_FE_OR_021_eemd_V);

IMF_7 = [IMF_DE_OR_021_eemd_V, IMF_FE_OR_021_eemd_V];

Label8=8*ones(L,1);
Label8 = num2cell(Label8);

IMF_DE_BF_007_eemd_V=horzcat(IMF_DE_BF_007_rms,IMF_DE_BF_007_var,IMF_DE_BF_007_means,IMF_DE_BF_007_std,IMF_DE_BF_007_kurtosis,...
    IMF_DE_BF_007_skewness,IMF_DE_BF_007_peaks, IMF_DE_BF_007_crestFactor, IMF_DE_BF_007_entropy);
IMF_FE_BF_007_eemd_V=horzcat(IMF_FE_BF_007_rms,IMF_FE_BF_007_var,IMF_FE_BF_007_means,IMF_FE_BF_007_std,IMF_FE_BF_007_kurtosis,...
    IMF_FE_BF_007_skewness,IMF_FE_BF_007_peaks, IMF_FE_BF_007_crestFactor, IMF_FE_BF_007_entropy,Label8);

IMF_DE_BF_007_eemd_V = cell2mat(IMF_DE_BF_007_eemd_V);
IMF_FE_BF_007_eemd_V = cell2mat(IMF_FE_BF_007_eemd_V);

IMF_8 = [IMF_DE_BF_007_eemd_V, IMF_FE_BF_007_eemd_V];

Label9=9*ones(L,1);
Label9 = num2cell(Label9);

IMF_DE_BF_014_eemd_V=horzcat(IMF_DE_BF_014_rms,IMF_DE_BF_014_var,IMF_DE_BF_014_means,IMF_DE_BF_014_std,IMF_DE_BF_014_kurtosis,...
    IMF_DE_BF_014_skewness,IMF_DE_BF_014_peaks, IMF_DE_BF_014_crestFactor, IMF_DE_BF_014_entropy);
IMF_FE_BF_014_eemd_V=horzcat(IMF_FE_BF_014_rms,IMF_FE_BF_014_var,IMF_FE_BF_014_means,IMF_FE_BF_014_std,IMF_FE_BF_014_kurtosis,...
    IMF_FE_BF_014_skewness,IMF_FE_BF_014_peaks, IMF_FE_BF_014_crestFactor, IMF_FE_BF_014_entropy,Label9);

IMF_DE_BF_014_eemd_V = cell2mat(IMF_DE_BF_014_eemd_V);
IMF_FE_BF_014_eemd_V = cell2mat(IMF_FE_BF_014_eemd_V);

IMF_9 = [IMF_DE_BF_014_eemd_V, IMF_FE_BF_014_eemd_V];

Label10=10*ones(L,1);
Label10 = num2cell(Label10);

IMF_DE_BF_021_eemd_V=horzcat(IMF_DE_BF_021_rms,IMF_DE_BF_021_var,IMF_DE_BF_021_means,IMF_DE_BF_021_std,IMF_DE_BF_021_kurtosis,...
    IMF_DE_BF_021_skewness,IMF_DE_BF_021_peaks, IMF_DE_BF_021_crestFactor, IMF_DE_BF_021_entropy);
IMF_FE_BF_021_eemd_V=horzcat(IMF_FE_BF_021_rms,IMF_FE_BF_021_var,IMF_FE_BF_021_means,IMF_FE_BF_021_std,IMF_FE_BF_021_kurtosis,...
    IMF_FE_BF_021_skewness,IMF_FE_BF_021_peaks, IMF_FE_BF_021_crestFactor, IMF_FE_BF_021_entropy,Label10);

IMF_DE_BF_021_eemd_V = cell2mat(IMF_DE_BF_021_eemd_V);
IMF_FE_BF_021_eemd_V = cell2mat(IMF_FE_BF_021_eemd_V);

IMF_10 = [IMF_DE_BF_021_eemd_V, IMF_FE_BF_021_eemd_V];
...
csvwrite('EEMD_10.csv',Array_Feat);